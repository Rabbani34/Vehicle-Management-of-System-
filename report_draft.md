Project Title: Vehicle Management of System
...
1.Implement a grid-based navigation system in Java
...
2.Support multiple search algorithms (BFS, UCS, A*)
...
3.Integrate admissible heuristics such as Manhattan and Euclidean distance
...
4.Load maps from text files and update obstacles dynamically
...
5.Provide a command-line interface with user-configurable parameters
...
6.Log experiment results (path, statistics, time, nodes expanded)
...
7.Generate 2D visualizations of grid maps with highlighted paths
...
2.Wikipedia – BFS, UCS, and A Search Algorithms*
3.Oracle Java Documentation – Core Java 17 Features
